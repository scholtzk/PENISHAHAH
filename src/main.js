...
class FirstPersonCamera {
  ...
  updateCamera_(_) {
    ...
    this.camera_.position.y += Math.sin(this.headBobTimer_ * 8) * 1.5;
...
class FirstPersonCameraDemo {
  ...
  initializeScene_() {
    ...
    const checkerboard = mapLoader.load('resources/board2.jpg');
  ...
  loadMaterial_(name, tiling) {
    ...
    const metalMap = mapLoader.load('resources/freepbr/' + '2.jpg');
    metalMap.anisotropy = maxAnisotropy;
    metalMap.wrapS = THREE.RepeatWrapping;
    metalMap.wrapT = THREE.RepeatWrapping;
    metalMap.repeat.set(tiling, tiling);

    const albedo = mapLoader.load('resources/freepbr/' + '1.jpg');
    ...
    const normalMap = mapLoader.load('resources/freepbr/' + name + '4.jpg');
    normalMap.anisotropy = maxAnisotropy;
    normalMap.wrapS = THREE.RepeatWrapping;
    normalMap.wrapT = THREE.RepeatWrapping;
    normalMap.repeat.set(tiling, tiling);

    const roughnessMap = mapLoader.load('resources/freepbr/' + name + '4.jpg');
